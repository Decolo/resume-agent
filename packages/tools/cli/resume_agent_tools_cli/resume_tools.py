...
the actual resume logic to ``resume_agent_domain``.
"""
...
from resume_agent_domain.ats_scorer import format_ats_report, score_ats
from resume_agent_domain.job_matcher import format_match_report, match_job
from resume_agent_domain.resume_parser import extract_sections, json_resume_to_text
from resume_agent_domain.resume_validator import (
...
class ResumeWriterTool(BaseTool):
    ...
    def _load_template_css(self, template: str) -> str | None:
        ...
        try:
            from resume_agent_core.templates import load_template_css
